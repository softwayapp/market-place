...
여러 Molecule과 Atom을 조합하여 페이지의 주요 섹션을 구성합니다. Header, Footer, Navigation, Form 등 독립적으로 동작하는 복잡한 UI 단위입니다.
...
export const headerVariants = {
  ...
  titleRow: 'flex-row items-center justify-between mb-3',
} as const;
...
export function Header({
  ...
  return (
    <View className={`${headerVariants.container} ${className}`}>
      <View className={headerVariants.titleRow}>
